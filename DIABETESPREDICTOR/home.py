...
def app():
    ...
    with col1:
        ...
        st.image("DIABETESPREDICTOR/Images/polyuria.jpg", use_column_width=True)
        st.write("""
    ...
    with col2:
        ...
        st.image("DIABETESPREDICTOR/Images/polydipsia.webp", use_column_width=True)
        st.write("""
    ...
    with col3:
        ...
        st.image("DIABETESPREDICTOR/Images/polyphagia.webp", use_column_width=True)
        st.write("""
    ...
    with col4:
        with st.expander("SUDDEN WEIGHT LOSS "):
            st.image("DIABETESPREDICTOR/Images/suddenweightloss.webp", use_column_width=True)
            st.write("""
    ...
    with col5:
        with st.expander("WEAKNESS "):
            st.image("DIABETESPREDICTOR/Images/weakness.webp", use_column_width=True)
            st.write("""
    ...
    with col6:
        with st.expander("GENITAL THRUSH "):
            st.image("DIABETESPREDICTOR/Images/genital thrush.webp", use_column_width=True)
            st.write("""
    ...
    with col7:
        with st.expander("VISUAL BLURRING "):
            st.image("DIABETESPREDICTOR/Images/sight.webp", use_column_width=True)
            st.write("""
    ...
    with col8:
        with st.expander("ITCHING "):
            st.image("DIABETESPREDICTOR/Images/itching.webp", use_column_width=True)
            st.write("""
    ...
    with col9:
        with st.expander("IRRITABILITY "):
            st.image("DIABETESPREDICTOR/Images/irritability.webp", use_column_width=True)
            st.write("""
    ...
    with col10:
        with st.expander("DELAYED HEALING "):
            st.image("DIABETESPREDICTOR/Images/delayed healing.webp", use_column_width=True)
            st.write("""
    ...
    with col11:
        with st.expander("PARTIAL PARESIS  "):
            st.image("DIABETESPREDICTOR/Images/partialparesis.webp", use_column_width=True)
            st.write("""
    ...
    with col12:
        with st.expander("MUSCLE STIFFNESS "):
            st.image("DIABETESPREDICTOR/Images/musclestiffness.webp", use_column_width=True)
            st.write("""
    ...
    with col13:
        with st.expander("ALOPECIA (HAIR LOSS)  "):
            st.image("DIABETESPREDICTOR/Images/hairloss.webp", use_column_width=True)
            st.write("""
    ...
    with col14:
        with st.expander("OBESITY "):
            st.image("DIABETESPREDICTOR/Images/obesity.webp", use_column_width=True)
            st.write("""
